  ...
  <footer class="site-footer">
    <div class="site-footer-top">
      <div class="container">
        <div class="row">
          <div class="col-lg-6 col-12">
            <h2 class="text-white mb-lg-0">Siguenos en Nuestras Redes Sociales</h2>
          </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-md-6 col-12 mb-4 mb-lg-0">
          ...
          <p class="text-white d-flex mb-1">
            <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>+591 78654870</p>
            <p class="mb-2"><i class="fa fa-envelope me-3"></i>CAFEcapital@gmail.com</p>
          </p>
        </div>

        <div class="col-lg-3 col-md-6 col-11 mb-4 mb-lg-0 mb-md-0">
          <h5 class="site-footer-title mb-3">Dirección de la Tienda</h5>

          <p class="text-white d-flex mt-3 mb-2">
            <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>Av. Las Americas 481</p>
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="site-footer-bottom">
      <div class="container">
        <div class="row">
          <div class="col-lg-3 col-12 mt-5">
            <p class="copyright-text">Copyright © 2036 Cafeteria CAFE CAPITAL Compania</p>
          </div>
